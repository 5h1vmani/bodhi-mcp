...
| Brand needs 90% consistency, 10% tenant customization    | Fixed semantic signals (success=green, error=red) + swappable brand accent       | The 90/10 rule: lock semantic meanings; only accent/brand varies per tenant; Microsoft and Google confirm this via alias token architecture |
